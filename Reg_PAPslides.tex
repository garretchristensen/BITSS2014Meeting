...
\begin{frame}{Publication Bias}%{Subtitles are optional.}
  ...
  \item
  	Data on the full set of experiments run with a large survey shows strong results are 40pp more likely to be published, and 60pp more likely to be written up. The file drawer problem is massive. (Franco, Malhotra, Simonovits 2014---see tomorrow)
  \end{itemize}
\end{frame}
